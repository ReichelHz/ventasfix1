            ...
            <div class="card shadow p-4">
                ...
                <form action="{{ route('clientes.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="rut_empresa" class="form-control" value="{{ old('rut_empresa') }}" required pattern="\d{7,8}-[\dkK]" title="Formato: 12345678-9">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="telefono" class="form-control" value="{{ old('telefono') }}" required pattern="\d{7,15}" title="Solo números, 7-15 dígitos">
                    </div>
